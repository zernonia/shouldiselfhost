...
Zight is a capture app with hosting attached. Zipline hosts files fine, but the screenshot-annotate-share flow lives in the client app — which stays subscription-bound. Self-hosting the storage half of a $9.95 tool solves the cheap half.
